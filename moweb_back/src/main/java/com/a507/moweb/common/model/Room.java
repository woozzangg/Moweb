...
public class Room implements Closeable {
    ...
    public User join(String userName, String sessionId, SimpMessagingTemplate template) throws IOException {
        log.info("ROOM {}: adding participant {}", this.name, userName);
        final User participant = new User(userName, this.name, sessionId, template, this.pipeline);
