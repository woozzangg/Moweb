...
public class User implements Closeable {
    ...
    public User(final String sessionId, final String name, String roomName, final SimpMessagingTemplate template,
        ...
        this.outgoingMedia.addIceCandidateFoundListener(new EventListener<IceCandidateFoundEvent>() {
            ...
            public void onEvent(IceCandidateFoundEvent event) {
                ...
                template.convertAndSendToUser(name, "/webrtc/queue", response.toString());
            }
        });
    }
        ...
        incoming.release(new Continuation<Void>() {
            ...
            public void onSuccess(Void result) throws Exception {
                log.trace("PARTICIPANT {}: Released successfully incoming EP for {}",
                        User.this.name, senderName);
            }

            @Override
            public void onError(Throwable cause) throws Exception {
                log.warn("PARTICIPANT {}: Could not release incoming EP for {}", User.this.name,
                        senderName);
            }
        });
    }
    ...
    public void close() throws IOException {
        ...
        for (final String remoteParticipantName : incomingMedia.keySet()) {
            ...
            ep.release(new Continuation<Void>() {
                ...
                public void onSuccess(Void result) throws Exception {
                    log.trace("PARTICIPANT {}: Released successfully incoming EP for {}",
                            User.this.name, remoteParticipantName);
                }
        ...
        outgoingMedia.release(new Continuation<Void>() {
            ...
            @Override
            public void onSuccess(Void result) throws Exception {
                log.trace("PARTICIPANT {}: Released outgoing EP", User.this.name);
            }

            @Override
            public void onError(Throwable cause) throws Exception {
                log.warn("USER {}: Could not release outgoing EP", User.this.name);
            }
        });
    }
    ...
    public void sendMessage(JsonObject message) throws IOException {
        ...
        template.convertAndSendToUser(name, "/webrtc/queue", message.toString());
    }
