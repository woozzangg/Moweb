...
export default {
  ...
  methods: {
    ...
    async userSet() {
      ...
      await navigator.mediaDevices
        ...
        .then((stream) => {
          ...
          let recordStream = this.createRecordStream(videoStream, {
            mimeType: "video/webm; codecs=vp8",
            interval: 100,
          });
          this.$refs["record"] = recordStream;
    ...
    initCall(data) {
      ...
      const conn = peer.connect(data.signal);
      conn.on("open", () => {
        console.log("open1");
        console.log(conn);
        conn.on("data", (data) => {
